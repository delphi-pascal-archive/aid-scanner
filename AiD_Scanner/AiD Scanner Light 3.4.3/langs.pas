...
type
    ...
    public
      ...
      procedure ChangeLang(frm: TForm; LangID, SublangId: DWORD; filen: String = '');
      procedure SwitchAllFormsTo(LangID, SublangID: DWORD; langFile: String);
    end;

    procedure SwitchAllFormsToLng(LangID, SublangID: DWORD; langFile: String);
...
begin
     IniFile := TIniFile.Create('D:\DoGeR.lng');
...
procedure TLangs.ChangeLang(frm: TForm; LangID, SublangId: DWORD; filen: String = '');
var
   i, j, k: integer;
   IniFile: TIniFile;
   Comp: TComponent;
...
begin
     for i:=0 to Screen.FormCount - 1 do
       if Screen.Forms[i].Tag = 0 then
          SupportedLangs.ChangeLang(Screen.Forms[i], LangID, SublangID, langFile);
end;

procedure TLangs.SwitchAllFormsTo(LangID, SublangID: DWORD; langFile: String);
var
   i: integer;
begin
     for i:=0 to Screen.FormCount - 1 do
       if Screen.Forms[i].Tag = 0 then
          ChangeLang(Screen.Forms[i], LangID, SublangID, langFile);
end;
