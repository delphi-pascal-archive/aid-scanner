object AboutForm: TAboutForm
  ...
  object NameToLabel: TLabel
    Left = 16
    Top = 64
    Width = 151
    Height = 13
    Caption = 'AiD Scanner free Antivirus'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object smallLicenseLabel: TLabel
    Left = 16
    Top = 224
    Width = 377
    Height = 57
    AutoSize = False
    Caption = 
      #1055#1088#1077#1076#1091#1087#1088#1077#1078#1076#1077#1085#1080#1077': '#1069#1090#1072' '#1087#1088#1086#1075#1088#1072#1084#1084#1072' '#1103#1074#1083#1103#1077#1090#1089#1103' '#1089#1086#1073#1089#1090#1074#1077#1085#1085#1086#1089#1090#1100#1102' bit-lab. '#1050 +
      #1086#1087#1080#1088#1086#1074#1072#1085#1080#1077' '#1080#1083#1080' '#1088#1072#1089#1087#1088#1086#1089#1090#1088#1072#1085#1077#1085#1080#1077' '#1076#1083#1103' '#1087#1086#1083#1091#1095#1077#1085#1080#1103' '#1082#1072#1082#1086#1081' '#1083#1080#1073#1086' '#1082#1086#1084#1084#1077#1088#1095#1077 +
      #1089#1082#1086#1081' '#1074#1099#1075#1086#1076#1099', '#1073#1077#1079' '#1089#1087#1077#1094#1080#1072#1083#1100#1085#1086#1075#1086' '#1088#1072#1079#1088#1077#1096#1077#1085#1080#1103' bit-lab, '#1089#1090#1088#1086#1075#1086' '#1079#1072#1087#1088#1077#1097#1077 +
      #1085#1086'.'
    WordWrap = True
  end
  object TopPanel: TPanel
    ...
    object CopyRightLabel: TLabel
      ...
      Width = 255
      Height = 13
      Caption = #1055#1088#1086#1080#1079#1074#1077#1076#1077#1085#1086' '#169' bit-lab 2008 '#1042#1089#1077' '#1087#1088#1072#1074#1072' '#1079#1072#1097#1080#1097#1077#1085#1099'.'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
